...
class AccountFromScreen extends StatefulWidget {
  ...
  const AccountFromScreen({super.key, required this.onAdd});
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              TextFormField(controller: _bankNameController, 
              decoration: const InputDecoration(labelText: '銀行名'), 
              validator: (v) => v!.isEmpty ? '必須項目です' : null),
              TextFormField(controller: _branchNameController, 
              decoration: const InputDecoration(labelText: '支店名')),
              TextFormField(controller: _branchNumberController, 
              ...
              CheckboxListTile(
                ...
                onChanged: (value) => setState(() => _isAutoWithdrawal = value!),
              ),
  TextFormField(controller: _linkedAppController, decoration: const InputDecoration(labelText: '連携アプリ')),
              TextFormField(controller: _memoController, decoration: const InputDecoration(labelText: 'メモ')),
